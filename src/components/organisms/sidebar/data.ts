        ...
        children: [
          {
            ...
            permissions: ['ROLE_PRODUCT_EVENTS_OVERVIEW'],
          },
          {
            title: 'funnel',
            ...
            permissions: ['ROLE_PRODUCT_FUNNEL_LIST'],
          },
          {
            title: 'cohort',
            icon: 'data',
          ...
          },
          {
            ...
            permissions: ['ROLE_APP_UNINSTALL_OVERVIEW'],
          },
        ],
      },
      {
        ...
        children: [
          {
            ...
            permissions: [],
            children: [],
            href: '/product/:productId/channels/push/campaigns',
          },
          {
            title: 'web push',
            ...
            permissions: [],
            children: [],
            href: '/product/:productId/channels/webPush/campaigns',
          },
          {
            title: 'sms',
            ...
            permissions: [],
            children: [],
            href: '/product/:productId/channels/sms/campaigns',
          },
          {
            title: 'email',
            icon: 'mail-01',
            permissions: [],
            children: [],
            href: '/product/:productId/channels/email/campaigns',
          },
          {
            ...
            permissions: [],
            children: [],
            href: '/product/:productId/channels/custom/campaigns',
          },
          {
            title: 'WhatsApp',
            icon: 'whatsapp-line',
            permissions: [],
            children: [],
            href: '/product/:productId/channels/whatsapp/campaigns',
          },
          {
            title: 'telegram',
            icon: 'telegram-line',
            permissions: [],
            children: [],
            href: '/product/:productId/channels/telegram/campaigns',
          },
        ],
        ...
        children: [
          {
            ...
            icon: 'monitor-02',
            children: [],
            href: '/product/:productId/personalization/onSite/campaigns',
          },
          {
            title: 'survey',
            icon: 'bar-chart-square-02',
            children: [],
            href: '/product/:productId/personalization/survey/campaigns',
          },
        ],
        ...
        children: [
          {
            ...
            icon: 'phone-02',
            children: [],
            href: '/product/:productId/personalization/inApp/campaigns',
          },
        ],
        href: '/personalization',
      },
